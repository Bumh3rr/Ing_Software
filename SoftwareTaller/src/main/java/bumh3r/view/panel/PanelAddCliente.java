...
public class PanelAddCliente extends Panel {
    ...
    private InputText firstname,address;
    private InputTextPhone phone1, phone2;
    ...
    private void initComponents() {
        phone1 = new InputTextPhone();
        phone2 = new InputTextPhone();
        firstname = new InputText("Ingrese Nombre completo", 100).setIcon(PathResources.Icon.modal + "ic_name.svg");
    ...
    private void init() {
        ...
        add(firstname);
        add(createdGramatical("Teléfono 1"));
        add(phone1);
        add(createdGramatical("Teléfono 2"));
        add(phone2);
