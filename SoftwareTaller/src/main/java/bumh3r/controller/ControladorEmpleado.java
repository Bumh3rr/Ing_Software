...
public class ControladorEmpleado extends Controller {
    public static String KEY = ControladorEmpleado.class.getName();
    private final FormEmployee view;
    private final EmpleadoDAO empleadoDAO;
    private PanelAddEmployee panelAddEmployee;

    public ControladorEmpleado(FormEmployee view) {
        this.view = view;
