...
public class InputTextPhone extends FlatFormattedTextField {
    ...
    public InputTextPhone() {
        icon = new FlatSVGIcon(modal + "ic_phone.svg", 0.35f);
        ...
        addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                baseIcon.setIcon(new FlatSVGIcon(modal + "ic_phone.svg", 0.35f).setColorFilter(new FlatSVGIcon.ColorFilter((x) -> UIManager.getColor("Component.accentColor"))));
